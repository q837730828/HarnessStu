...
import com.ahi.harness.tools.DocReadTool;
...
import com.ahi.harness.tools.SkillLoadTool;
...
public class BuiltInToolProvider implements ToolProvider {
    ...
    public List<Tool> loadTools() {
        ...
        tools.add(new DocReadTool(workspace));
        tools.add(new SkillLoadTool(workspace));
